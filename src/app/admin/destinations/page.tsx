...
export default function AdminDestinations() {
    ...
    const handleDelete = async (id: string) => {
        if (!window.confirm("Are you sure you want to delete this heritage site? This action cannot be undone.")) return;
    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-bold text-primary tracking-tight uppercase">Registry <span className="text-accent underline decoration-primary/10 underline-offset-[12px]">Management</span></h1>
                ...
                <button
                    ...
                    className="bg-primary text-white px-8 py-4 rounded-[2px] font-bold text-xs uppercase tracking-wider flex items-center gap-3 hover:bg-black transition-all shadow-xl shadow-primary/20"
                >
                ...
                <div className="flex items-center gap-4">
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="bg-white border border-primary/5 rounded-[2px] pl-10 pr-4 py-3 text-sm font-medium outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent/40 transition-all w-72 shadow-sm"
                        />
                    </div>
                    <button className="flex items-center gap-2 px-5 py-3 bg-white border border-primary/5 rounded-[2px] text-primary/70 text-xs font-bold uppercase tracking-wider hover:bg-primary hover:text-white transition-all shadow-sm group">
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 px-4 py-4 bg-primary text-white rounded-[2px] text-xs font-bold uppercase tracking-wider hover:bg-primary/95 transition-all shadow-lg shadow-primary/20"
                                >
            ...
            <div className="flex items-center justify-between pt-4 pb-12">
                ...
                <div className="flex gap-3">
                    <button className="p-3 border border-primary/5 bg-white rounded-[2px] text-primary/20 hover:bg-primary hover:text-white transition-all shadow-sm opacity-50 cursor-not-allowed">
                        <ChevronLeft size={20} />
                    </button>
                    <button className="p-3 border border-primary/5 bg-white rounded-[2px] text-primary/20 hover:bg-primary hover:text-white transition-all shadow-sm">
                        ...
                        >
                                        ...
                                        <div className={`w-full h-48 rounded-[2px] border-2 border-dashed transition-all flex flex-col items-center justify-center gap-3 overflow-hidden ${imagePreview ? 'border-accent bg-accent/5' : 'border-primary/10 bg-[#FAF9F6] group-hover:border-accent/40'}`}>
                                            ...
                                            {imagePreview && (
                                                <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <p className="text-[10px] font-black text-white uppercase tracking-[0.2em] bg-primary/80 px-4 py-2 rounded-lg">Replace Image</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-6 pt-2">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[#FAF9F6] border border-primary/5 rounded-[2px] px-5 py-3 text-xs font-bold outline-none focus:border-accent/40 focus:ring-4 focus:ring-accent/5 transition-all"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-[#FAF9F6] border border-primary/5 rounded-[2px] px-5 py-3 text-xs font-bold outline-none focus:border-accent/40 transition-all appearance-none cursor-pointer"
                                        >
                            ...
                            <div className="p-8 border-t border-primary/5 bg-[#FAF9F6] flex gap-4">
                                <button
                                    ...
                                    className="flex-1 py-4 border border-primary/5 rounded-[2px] text-[10px] font-black uppercase tracking-widest text-primary/40 hover:bg-white hover:text-primary transition-all"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="flex-[2] py-4 bg-primary text-white rounded-[2px] text-[10px] font-black uppercase tracking-widest hover:bg-primary/95 transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2 group disabled:opacity-50"
                                >
                                    {isSubmitting ? (
                                        <div className="w-4 h-4 rounded-full border-2 border-accent border-t-transparent animate-spin" />
                                    ) : (
