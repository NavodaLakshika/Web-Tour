    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-heading font-black text-primary tracking-tight uppercase">Experience <span className="text-accent underline decoration-primary/10 underline-offset-8">Registry</span></h1>
                    <div className="flex items-center gap-3 mt-3">
                        <div className="bg-primary/5 px-3 py-1.5 rounded-md border border-primary/5 flex items-center gap-2">
                            <Briefcase size={14} className="text-accent" />
                            <span className="text-[10px] font-black text-primary uppercase tracking-[0.2em]">Active Expeditions</span>
                        </div>
                        <p className="text-primary/40 font-bold text-[11px] uppercase tracking-widest">Curated Series Standards</p>
                    </div>
                </div>
                <button
            ...
            {isLoading && (
                <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-xl border border-primary/5 animate-pulse">
                    ...
                    <span className="text-[10px] font-black text-primary/40 uppercase tracking-[0.2em]">Syncing Series with Supabase...</span>
                </div>
            )}
            ...
            {!isLoading && dbExperiences.length === 0 && (
                <div className="flex items-center gap-3 p-4 bg-orange-50 rounded-xl border border-orange-100">
                    ...
                    <span className="text-[10px] font-black text-orange-600 uppercase tracking-[0.2em]">Running on Local Series Backup</span>
                </div>
            )}
            ...
            {/* Filters & Search */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <h3 className="text-[10px] font-black text-primary/40 uppercase tracking-[0.3em]">{filteredExperiences.length} SERIES VERIFIED</h3>
                ...
                {filteredExperiences.map((exp, i) => (
                    <div key={i} className="bg-white rounded-[24px] border border-primary/5 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden group relative">
                        <div className="absolute top-4 right-4 z-10">
                            <div className="bg-primary/90 backdrop-blur-md px-3 py-1.5 rounded-lg border border-accent/20 flex items-center gap-1.5 shadow-xl">
                                <Zap size={10} className="text-accent fill-accent" />
                                <span className="text-[9px] font-black text-white uppercase tracking-widest">{exp.category}</span>
                            </div>
                        </div>
                        ...
                        <div className="p-8">
                            <div className="flex items-start justify-between mb-8">
                                <div className="flex items-center gap-4">
                                    <div className="relative w-14 h-14 rounded-2xl overflow-hidden flex-shrink-0 border border-primary/5 bg-primary/5 group-hover:scale-110 transition-transform duration-500">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1.5">
                                            ...
                                            <span className="text-[10px] font-black text-primary/40 uppercase tracking-widest">{exp.location}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex divide-x divide-primary/5 py-6 border-y border-primary/5 mb-8 bg-[#FAF9F6]/50 rounded-xl px-4">
                                <div className="flex-1 text-center">
                                    <p className="text-[10px] font-black text-primary leading-tight uppercase tracking-tight">{exp.duration}</p>
                                    <p className="text-[9px] font-black text-primary/20 mt-1 uppercase tracking-[0.2em]">DURATION</p>
                                </div>
                                <div className="flex-1 text-center pl-6">
                                    <p className="text-[10px] font-black text-primary leading-tight uppercase">{exp.price}</p>
                                    <p className="text-[9px] font-black text-primary/20 mt-1 uppercase tracking-[0.2em]">FEES</p>
                                </div>
                            </div>
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="p-8 border-b border-primary/5 flex items-center justify-between bg-[#FAF9F6]">
                                <div>
                                    <h2 className="text-2xl font-heading font-black text-primary uppercase tracking-tight">New <span className="text-accent">Experience Series</span></h2>
                                    <p className="text-[10px] font-black text-primary/30 uppercase tracking-widest mt-1">Expanding the Signature Portfolio</p>
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 space-y-6 scrollbar-hide">
                                ...
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black text-primary/40 uppercase tracking-widest ml-1">Series Imagery</label>
                                    <div className="relative group">
                                        <input
                                            type="file"
                                            accept="image/*"
                                            ...
                                            {imagePreview ? (
                                                ...
                                                <>
                                                    ...
                                                    <div className="text-center">
                                                        <p className="text-[11px] font-black text-primary uppercase tracking-widest">Select Series Image</p>
                                ...
                                <div className="grid grid-cols-2 gap-6 pt-2">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-primary/40 uppercase tracking-widest ml-1">Series Title</label>
                                        <input
                                            required
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-primary/40 uppercase tracking-widest ml-1">Series Category</label>
                                        <select
                                            value={formData.category}
                                            onChange={(e) => setFormData({ ...formData, category: e.target.value })}
                                            className="w-full bg-[#FAF9F6] border border-primary/5 rounded-xl px-5 py-3 text-xs font-bold outline-none focus:border-accent/40 transition-all appearance-none cursor-pointer"
                                        >
                                            {["Adventure", "Wildlife", "Culinary", "Wellness", "Festivals", "Heritage"].map(c => <option key={c} value={c}>{c}</option>)}
                                        </select>
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-primary/40 uppercase tracking-widest ml-1">Duration</label>
                                        <input
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-primary/40 uppercase tracking-widest ml-1">In-depth Narrative</label>
                                    <textarea
                                        required
                                ...
                                <div className="grid grid-cols-2 gap-6 pb-4">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-primary/40 uppercase tracking-widest ml-1">Difficulty Level</label>
                                        <select
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-primary/40 uppercase tracking-widest ml-1">Estimated Fees</label>
                                        <input
                            ...
                            <div className="p-8 border-t border-primary/5 bg-[#FAF9F6] flex gap-4">
                                <button
                                    onClick={() => setIsModalOpen(false)}
                                    className="flex-1 py-4 border border-primary/5 rounded-xl text-[10px] font-black uppercase tracking-widest text-primary/40 hover:bg-white hover:text-primary transition-all"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="flex-[2] py-4 bg-primary text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-primary/95 transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2 group disabled:opacity-50"
                                >
                                    {isSubmitting ? (
                                        <div className="w-4 h-4 rounded-full border-2 border-accent border-t-transparent animate-spin" />
                                    ) : (
                                        <>
                                            ...
                                            <span>Authorize Series Entry</span>
                                        </>
                                    )}
                                </button>
                            </div>
